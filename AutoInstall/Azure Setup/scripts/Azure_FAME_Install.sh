...
source /tmp/Azure_Network.conf
#cuckoo.py
#sudo sed -i -e "s;cuckoo_ip;$cuck_address;;;" /home/fame/fame/fame/modules/community/processing/cuckoo_modified/cuckoo.py
sudo sed -i s/cuck_ip/$cuck_address/ > sudo /home/fame/fame/fame/modules/community/processing/cuckoo_modified/cuckoo.py

#Mastiff.py
#sudo sed -i -e "s;mastiff_ip;$mas_address;;;" /home/fame/fame/fame/modules/community/processing/mastiff/Mastiff.py
sudo sed -i s/mastiff_ip/$mas_address/ > sudo /home/fame/fame/fame/modules/community/processing/mastiff/Mastiff.py

#viper.py
#sudo sed -i -e "s;viper_ip;$vip_address;;;" /home/fame/fame/fame/modules/community/processing/viper/viper.py
sudo sed -i s/viper_ip/$vip_address/ > sudo /home/fame/fame/fame/modules/community/processing/viper/viper.py

#get_api.py
#sudo sed -i -e "s;misp_ip;$misp_address;;;" /home/fame/fame/get_api.py
sudo sed -i s/misp_ip/$misp_address/ > sudo /home/fame/fame/fame/get_api.py

#MISPmod.py
#sudo sed -i -e "s;cuckoo_ip;$cuck_address;;;" /home/fame/fame/fame/modules/community/processing/cuckoo_modified/MISPmod.py
#sudo sed -i -e "s;misp_ip;$misp_address;;;" /home/fame/fame/fame/modules/community/processing/cuckoo_modified/MISPmod.py

sudo sed -i s/cuckoo_ip/$cuck_address/ > sudo /home/fame/fame/fame/modules/community/processing/cuckoo_modified/MISPmod.py
sudo sed -i s/misp_ip/$misp_address/ > sudo /home/fame/fame/fame/modules/community/processing/cuckoo_modified/MISPmod.py
