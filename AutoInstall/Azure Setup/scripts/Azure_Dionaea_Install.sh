...
#Set dionaea password
passwd_dionaea=$(expect -c "
spawn sudo passwd dionaea
...
sudo cp /home/dionaea/CustomUploader.py /opt/dionaea/lib/dionaea/python/dionaea/CustomUploader.py
#sudo rm /home/dionaea/README.md
...
sudo sed -i s/fame_ip/$fame_address/ > sudo /opt/dionaea/lib/dionaea/python/dionaea/CustomUploader.py
